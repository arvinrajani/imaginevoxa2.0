...
function GuestGenerator() {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative bg-white/80 backdrop-blur-xl rounded-2xl border border-gray-200/60 shadow-lg overflow-hidden">
        <div className="p-6 sm:p-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <div>
              <h3 className="font-semibold text-gray-900">AI Post Generator</h3>
              <p className="text-sm text-gray-500">Try it free - no signup required</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200/60 bg-gray-100 focus:ring-2 focus:ring-cyan-50 focus:border-transparent transition-all"
              />
            </div>
            ...
            >
              <div className="p-6 sm:p-8 bg-[#0c1436]">
                <div className="flex items-center justify-between mb-4">
                  <span className="text-sm font-medium text-cyan-600 flex items-center gap-1">
    ...
    >
      <div
        className={`relative h-full rounded-2xl border ${
          popular ? 'border-cyan-400/40 bg-white/80' : 'border-gray-200/60 bg-white/80'
        }`}
      >
        <div
        ...
        {popular && (
          <div className="absolute -top-4 left-1/2 -translate-x-1/2">
            <span className="bg-gray-100 text-cyan-100 text-xs font-semibold px-4 py-1.5 rounded-full border border-gray-200/60">
              MOST POPULAR
            </span>
          </div>
        )}
        ...
        <div className="p-8 h-full flex flex-col">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm mt-1 text-gray-500">{credits}</p>
          </div>
...
function StatCard({ value, label, icon: Icon }: { value: string; label: string; icon: React.ElementType }) {
  return (
    <div className="text-center">
      <div className="inline-flex items-center justify-center h-12 w-12 rounded-xl bg-gray-100 border border-gray-200/60 mb-3">
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-gray-800">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-2xl border-b border-gray-200/40 shadow-sm shadow-gray-200/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center gap-1 rounded-full border border-gray-200/50 bg-gray-50/80 px-1.5 py-1 text-sm font-medium text-gray-600">
              <a href="#features" className="px-4 py-1.5 rounded-full hover:bg-white hover:text-gray-900 hover:shadow-sm transition-all">Features</a>
              <a href="#pricing" className="px-4 py-1.5 rounded-full hover:bg-white hover:text-gray-900 hover:shadow-sm transition-all">Pricing</a>
              <Link href="/demo" className="px-4 py-1.5 rounded-full hover:bg-white hover:text-gray-900 hover:shadow-sm transition-all">Demo</Link>
              <a href="#testimonials" className="px-4 py-1.5 rounded-full hover:bg-white hover:text-gray-900 hover:shadow-sm transition-all">Testimonials</a>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/signup">
                <Button className="bg-voxa-gradient hover:opacity-90 text-white px-6 shadow-lg shadow-cyan-500/20 hover:shadow-cyan-500/30 transition-shadow">
                  Get Started
                </Button>
              </Link>
            </div>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="h-14 px-8 font-semibold text-lg border-gray-300 text-gray-700 hover:bg-gray-100"
                  asChild
                >
                  <Link href="/demo">
              ...
              <div className="flex flex-wrap items-center gap-6">
                <div className="flex -space-x-2">
                  {[1, 2, 3, 4, 5].map((i) => (
                    <div
                      key={i}
                      className="h-10 w-10 rounded-full border-2 border-gray-200/60 bg-voxa-gradient"
                    />
                  ))}
                </div>
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    <strong className="text-gray-900">2,500+</strong> creators trust us
                  </p>
                </div>
                <div className="text-xs text-gray-500 bg-gray-50 border border-gray-200/60 px-3 py-1.5 rounded-full">
                  Avg time saved per week: <span className="text-gray-900 font-semibold">5.2 hours</span>
                </div>
              </div>
            </motion.div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 border-y border-gray-200/60">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200/60">
            <p className="text-center text-sm text-gray-500 mb-6">Trusted by professionals from</p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="group bg-white rounded-2xl p-6 border border-gray-200/60 shadow-lg hover:shadow-xl transition-all"
              >
      ...
      {/* Voxa Advantage */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gray-50 border-y border-gray-200/60">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center">
            <div>
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <div key={item.title} className="rounded-2xl border border-gray-200/60 bg-white p-5">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={item.step} className="rounded-2xl border border-gray-200/60 bg-white p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-xs font-semibold text-cyan-600 bg-gray-100 px-3 py-1 rounded-full">
                      {item.step}
                    </span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <motion.div
                key={feature.title}
                whileHover={{ y: -6 }}
                className="group rounded-2xl border border-gray-200/60 bg-white p-6"
              >
      ...
      {/* Pricing Section */}
      <section id="pricing" className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
      ...
      {/* Footer */}
      <footer className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-50 border-t border-gray-200/60">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#features" className="text-sm text-gray-500 hover:text-cyan-600 transition-colors">Features</a></li>
                <li><a href="#pricing" className="text-sm text-gray-500 hover:text-cyan-600 transition-colors">Pricing</a></li>
                <li><a href="#" className="text-sm text-gray-500 hover:text-cyan-600 transition-colors">API <span className="text-xs bg-gray-100 text-cyan-600 px-1.5 py-0.5 rounded-full ml-1">Soon</span></a></li>
                <li><a href="#" className="text-sm text-gray-500 hover:text-cyan-600 transition-colors">Changelog</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-500">
                <p><span className="font-semibold text-gray-700">About Us:</span> We build AI workflows that turn LinkedIn posting into a consistent, brand-first routine.</p>
                <p><span className="font-semibold text-gray-700">Blog:</span> Practical playbooks on hooks, structure, cadence, and growth for busy professionals.</p>
                <p><span className="font-semibold text-gray-700">Careers:</span> We&apos;re building a world-class product team focused on creator outcomes.</p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3 text-sm text-gray-500">
                <p><span className="font-semibold text-gray-700">Privacy:</span> We never sell data and only store what&apos;s needed to generate and publish posts.</p>
                <p><span className="font-semibold text-gray-700">Terms:</span> Clear usage terms to keep your content, assets, and workflow protected.</p>
                <p><span className="font-semibold text-gray-700">Cookies:</span> Used strictly for authentication and a smoother in-app experience.</p>
                <p><span className="font-semibold text-gray-700">GDPR:</span> Built with privacy by design, data minimization, and user control.</p>
              </div>
            </div>
          </div>
