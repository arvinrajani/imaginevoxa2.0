              ...
              <div className="grid grid-cols-3 gap-2">
                {['professional', 'casual', 'bold'].map((t) => (
                  <button
                    key={t}
                    onClick={() => setTone(t)}
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all ${tone === t
...
function PricingCard({
  ...
  return (
    ...
    >
      <div
        className={`relative h-full rounded-2xl border ${popular ? 'border-cyan-400/40 bg-white/80' : 'border-gray-200/60 bg-white/80'
          }`}
      >
        <div
          className={`absolute inset-x-8 top-0 h-px ${popular
        ...
        <div className="p-8 h-full flex flex-col">
          ...
          <Link href="/signup">
            <Button
              className={`w-full h-12 font-semibold rounded-xl transition-all ${popular
