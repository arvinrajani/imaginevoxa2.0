    ...
    <div className="min-h-screen bg-transparent text-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden lg:flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-2 py-1 text-sm font-medium text-slate-300">
              ...
              <Link href="/pricing" className="px-3 py-1 rounded-full hover:bg-white/10 hover:text-white transition-colors">Pricing</Link>
              <Link href="/demo" className="px-3 py-1 rounded-full bg-white/10 text-white transition-colors">Demo</Link>
      ...
      <section className="pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-[1fr_1.1fr] gap-12 items-center">
            <div>
                  ...
                  <button
                    ...
                    className={`w-full text-left p-4 rounded-2xl border transition ${
                      activeStep === index
                        ...
                        : 'border-white/10 bg-[#0b1234]/60 hover:bg-white/5'
                    }`}
                  >
                    <div className="flex items-center gap-3">
                      <div className={`h-10 w-10 rounded-xl flex items-center justify-center ${
                        activeStep === index ? 'bg-voxa-gradient text-white' : 'bg-white/10 text-cyan-200'
                      }`}>
              ...
              <div className="mt-8 flex items-center gap-3">
                ...
                <Link href="/signup">
                  <Button className="bg-voxa-gradient hover:opacity-90 text-white">
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl border border-white/10 bg-[#0b1234]/90 shadow-voxa overflow-hidden">
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <span className="text-xs text-cyan-200 bg-white/10 px-3 py-1 rounded-full">
                  ...
                  <AnimatePresence mode="wait">
                    ...
                    >
                      {current.id === 'signup' && (
                        <div className="space-y-4">
                          <div className="grid gap-3">
                            <div className="h-10 rounded-xl bg-white/10 border border-white/10 flex items-center px-3 text-sm text-slate-300">
                              Name
                            </div>
                            <div className="h-10 rounded-xl bg-white/10 border border-white/10 flex items-center px-3 text-sm text-slate-300">
                              Email address
                      ...
                      {current.id === 'prompt' && (
                        <div className="space-y-4">
                          <div className="rounded-xl border border-white/10 bg-white/10 p-4 text-sm text-slate-200">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            {['Professional', 'Bold', 'Inspirational'].map((tone) => (
                              <span key={tone} className="text-xs text-slate-300 bg-white/10 border border-white/10 px-2 py-2 rounded-lg text-center">
                                {tone}
                              </span>
                            ))}
                          </div>
          ...
          <div className="mt-16 rounded-2xl border border-white/10 bg-[#0b1234]/70 p-6">
            <div className="flex items-center gap-3 mb-3">
              <Sparkles className="h-5 w-5 text-cyan-200" />
              <p className="font-semibold text-white">What this demo covers</p>
            </div>
