    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          >
            <div className="h-12 w-12 rounded-xl bg-gray-500 flex items-center justify-center mb-4">
          ...
          <button
            ...
            className={`p-6 rounded-2xl border-2 text-left transition-all ${
              success === 'pro'
                ? 'border-green-500 bg-green-50 dark:bg-green-900/20'
                : 'border-cyan-500 bg-gradient-to-br from-cyan-50 to-blue-50 dark:from-cyan-900/20 dark:to-blue-900/20 hover:border-cyan-600'
            }`}
          >
          ...
          <button
            ...
            className={`p-6 rounded-2xl border-2 text-left transition-all ${
              success === 'business'
                ? 'border-green-500 bg-green-50 dark:bg-green-900/20'
                : 'border-amber-400 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-900/20 dark:to-orange-900/20 hover:border-amber-500'
            }`}
          >
